...
def main():
    ...
    while opção != 0:
        ...
        if opção == 1:
            ...
            nome = input("Digite o nome do livro que você deseja remover: ").capitalize()
            ...
            genero = input("Digite o genero que você deseja buscar:").capitalize()
            ...
            nome = input("Digite o nome do livro que você deseja atualizar: ").capitalize()
            opcao = input("Digite o que você deseja atualizar no livro ('nome', 'preço', 'autor' ou 'genero'): ")
            valor = input(f"Digite o novo {opcao} que ira substituir o antigo: ").capitalize()
